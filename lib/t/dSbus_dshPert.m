function [num_dSbus_dPxsh] = dSbus_dshPert(baseMVA, bus, branch, V, side, pert, vcart)
...
elseif side ==2 %to side
    ...
    error('dSbus_dshPer: Side for element active power control can only be type 1 (from side) or 2 (to side)')    
end  
%% constants
