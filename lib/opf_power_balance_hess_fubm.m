...
if mpopt.opf.v_cartesian
    ...
    %%AAB------------------------------------------------------------------
    [Va, Vm, Pg, Qg, Beqz, Beqv, ShAng, maQt, maVt] = deal_vars(x, nBeqz, nBeqv, nPfsh, nQtma, nVtma, 1); %AAB- Deals optimisation variables
...
%AAB-----------------------------------------------------------------------
Gs11=real(Gp11)+ imag(Gq11);    Gs12=real(Gp12)+ imag(Gq12);    Gs13=sparse(nb,ng);          Gs14=sparse(nb,ng);          Gs15=real(Gp15)+ imag(Gq15);          Gs16=real(Gp16)+ imag(Gq16);          Gs17=real(Gp17)+ imag(Gq17);          Gs18=real(Gp18)+ imag(Gq18);          Gs19=real(Gp19)+ imag(Gq19);       
Gs21=real(Gp21)+ imag(Gq21);    Gs22=real(Gp22)+ imag(Gq22);    Gs23=sparse(nb,ng);          Gs24=sparse(nb,ng);          Gs25=real(Gp25)+ imag(Gq25);          Gs26=real(Gp26)+ imag(Gq26);          Gs27=real(Gp27)+ imag(Gq27);          Gs28=real(Gp28)+ imag(Gq28);          Gs29=real(Gp29)+ imag(Gq29);
Gs31=sparse(ng,nb);             Gs32=sparse(ng,nb);             Gs33=sparse(ng,ng);          Gs34=sparse(ng,ng);          Gs35=sparse(ng,nBeqz);                Gs36=sparse(ng,nBeqv);                Gs37=sparse(ng,nPfsh);                Gs38=sparse(ng,nQtma);                Gs39=sparse(ng,nVtma);
Gs41=sparse(ng,nb);             Gs42=sparse(ng,nb);             Gs43=sparse(ng,ng);          Gs44=sparse(ng,ng);          Gs45=sparse(ng,nBeqz);                Gs46=sparse(ng,nBeqv);                Gs47=sparse(ng,nPfsh);                Gs48=sparse(ng,nQtma);                Gs49=sparse(ng,nVtma);
Gs51=real(Gp51)+ imag(Gq51);    Gs52=real(Gp52)+ imag(Gq52);    Gs53=sparse(nBeqz,ng);       Gs54=sparse(nBeqz,ng);       Gs55=real(Gp55)+ imag(Gq55);          Gs56=real(Gp56)+ imag(Gq56);          Gs57=real(Gp57)+ imag(Gq57);          Gs58=real(Gp58)+ imag(Gq58);          Gs59=real(Gp59)+ imag(Gq59);
Gs61=real(Gp61)+ imag(Gq61);    Gs62=real(Gp62)+ imag(Gq62);    Gs63=sparse(nBeqv,ng);       Gs64=sparse(nBeqv,ng);       Gs65=real(Gp65)+ imag(Gq65);          Gs66=real(Gp66)+ imag(Gq66);          Gs67=real(Gp67)+ imag(Gq67);          Gs68=real(Gp68)+ imag(Gq68);          Gs69=real(Gp69)+ imag(Gq69);
Gs71=real(Gp71)+ imag(Gq71);    Gs72=real(Gp72)+ imag(Gq72);    Gs73=sparse(nPfsh,ng);       Gs74=sparse(nPfsh,ng);       Gs75=real(Gp75)+ imag(Gq75);          Gs76=real(Gp76)+ imag(Gq76);          Gs77=real(Gp77)+ imag(Gq77);          Gs78=real(Gp78)+ imag(Gq78);          Gs79=real(Gp79)+ imag(Gq79);
Gs81=real(Gp81)+ imag(Gq81);    Gs82=real(Gp82)+ imag(Gq82);    Gs83=sparse(nQtma,ng);       Gs84=sparse(nQtma,ng);       Gs85=real(Gp85)+ imag(Gq85);          Gs86=real(Gp86)+ imag(Gq86);          Gs87=real(Gp87)+ imag(Gq87);          Gs88=real(Gp88)+ imag(Gq88);          Gs89=real(Gp89)+ imag(Gq89);
Gs91=real(Gp91)+ imag(Gq91);    Gs92=real(Gp92)+ imag(Gq92);    Gs93=sparse(nVtma,ng);       Gs94=sparse(nVtma,ng);       Gs95=real(Gp95)+ imag(Gq95);          Gs96=real(Gp96)+ imag(Gq96);          Gs97=real(Gp97)+ imag(Gq97);          Gs98=real(Gp98)+ imag(Gq98);          Gs99=real(Gp99)+ imag(Gq99);

      %Va      Vm      Pg      Qg      Beqz    Beqv    ShAng   Qtma    Vtma
d2G = [Gs11    Gs12    Gs13    Gs14    Gs15    Gs16    Gs17    Gs18    Gs19;
       Gs21    Gs22    Gs23    Gs24    Gs25    Gs26    Gs27    Gs28    Gs29;
       Gs31    Gs32    Gs33    Gs34    Gs35    Gs36    Gs37    Gs38    Gs39;
       Gs41    Gs42    Gs43    Gs44    Gs45    Gs46    Gs47    Gs48    Gs49;
       Gs51    Gs52    Gs53    Gs54    Gs55    Gs56    Gs57    Gs58    Gs59;
       Gs61    Gs62    Gs63    Gs64    Gs65    Gs66    Gs67    Gs68    Gs69;
       Gs71    Gs72    Gs73    Gs74    Gs75    Gs76    Gs77    Gs78    Gs79;
       Gs81    Gs82    Gs83    Gs84    Gs85    Gs86    Gs87    Gs88    Gs89;
       Gs91    Gs92    Gs93    Gs94    Gs95    Gs96    Gs97    Gs98    Gs99;
