...
if nPfdp
    branch(iPfsh,SHIFT) = ShAngDp*180/pi;  %AAB- Update the data from Theta_shift Droop to the branch matrix (It is returnded to degrees since inside makeYbus_aab it is converted to radians).
end
...
Gs101=real(Gp101)+ imag(Gq101); Gs102=real(Gp102)+ imag(Gq102); Gs103=sparse(nVtma,ng);      Gs104=sparse(nVtma,ng);      Gs105=real(Gp105)+ imag(Gq105);       Gs106=real(Gp106)+ imag(Gq106);       Gs107=real(Gp107)+ imag(Gq107);       Gs108=real(Gp108)+ imag(Gq108);       Gs109=real(Gp109)+ imag(Gq109);       Gs1010=real(Gp1010)+ imag(Gq1010);
