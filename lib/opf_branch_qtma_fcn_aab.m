function [g, dg] = opf_branch_qtma_fcn_aab(x, mpc, iQtma, mpopt)
%OPF_BRANCH_QTMA_FCN_AAB  Evaluates Qt control constraints and Jacobian for elements with reactive power "to" control using ma
