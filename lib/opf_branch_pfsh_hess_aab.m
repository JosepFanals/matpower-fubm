function d2G = opf_branch_pfsh_hess_aab(x, lambda, mpc, iPfsh, mpopt)
%OPF_BRANCH_PFSH_HESS_AAB  Evaluates Hessian of branch Pf control constraints for elements with active power "from" control.
